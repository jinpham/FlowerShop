...
import flower_shop.dao.impl.RegisterDao;
...
public class RegistrationController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RegisterDao register = new RegisterDao(connectDB.creatConnection());
		if (register.RegisterUser(user)) // On success, you can display a message to user on Home page
		{
			request.setAttribute("Message", "Bạn đã tạo tài khoàn thành công. Mời bạn đăng nhập <a href='/Flower_Shop/view/client/login'>tại đây!</a>");
