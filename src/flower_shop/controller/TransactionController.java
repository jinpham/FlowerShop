...
import flower_shop.model.Item;
import flower_shop.model.Order;
...
public class TransactionController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String tr_received_date = req.getParameter("transaction_received_date");
		...
		transaction.setReceived_date(tr_received_date);
