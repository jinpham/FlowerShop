                  ...
                  <c:forEach items="${order}" var="order">
                      <tr>
                        ...
                        <td>${order.received_date } </td>
        				 ...
        				 <td>
        				 <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/order/edit?id=${order.id}">Cập nhật</a></button>
                         <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/order/delete?id=${order.id}">Hủy</a></button>       
                        </td>
                     </tr>
                    </c:forEach>
                    </tbody>
