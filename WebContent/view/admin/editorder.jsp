              ...
              <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/order/edit">
                 ...
                 <div class="form-group">
                  ...
                  <div>
                    <textarea class="form-control" rows="4" readonly="readonly" id="input-17" name="order-address">${order.address}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input-2" class="col-form-label">Ghi chú</label>
                  <div>
                    <textarea class="form-control" rows="4" readonly="readonly" id="input-17" name="order-mess">${order.message}</textarea>
                  </div>
                </div>
