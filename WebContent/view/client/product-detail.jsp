                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <c:choose>
	                    ...
	                    <c:otherwise>
	                      <c:forEach items="${productlist1}" var="product1">
		                      ...
		                      <span class="aa-product-price">${detail_product.price} VNĐ</del></span>
	                      </c:if>
	                      </c:forEach>
	                    </c:otherwise>
	                     </c:choose>
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="${pageContext.request.contextPath}/view/client/add-cart?product-id=${detail_product.id}">Add to cart</a>
                      <a class="aa-buy-now-btn" href="${pageContext.request.contextPath}/order-now?product-id=${detail_product.id}">Buy Now</a>
                    </div>
                  </div>
                </div>
              </div>
                 ...
                 <div class="aa-product-review-area">
                   ...
                   <form action="${pageContext.request.contextPath}/view/client/review?id=${detail_product.id}" method="post" class="aa-review-form">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="example@gmail.com" name="email" style ="width: 100%">
                      </div>
                      <div class="form-group">
                        <label for="message">Đánh giá của bạn</label>
                        <textarea class="form-control" rows="3" id="content" name="content" style ="width: 100%"></textarea>
                      </div>
