...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">Các hình thức thanh toán của Flower Shop</h1>
      		<p>Hiện tại đối với các đơn hàng đặt hàng trực tuyến trên website, <strong>Flower Shop</strong> có những hình thức thanh toán như sau:</p>
      		<strong>* Thanh toán tiền mặt: </strong>
			<p>Sau khi nhận được đơn hàng trên website, bộ phận chăm sóc khách hàng của <strong>Flower Shop</strong> sẽ liên hệ lại xác nhận đơn hàng với khách hàng,
			...
			<p>Sau khi nhận được đơn hàng trên website, bộ phận chăm sóc khách hàng của <strong>Flower Shop</strong> sẽ xác nhận đơn hàng với khách hàng,
