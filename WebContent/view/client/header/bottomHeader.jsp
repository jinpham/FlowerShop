...
<!--                <a href="index.jsp">
                ...
                <!-- img based logo -->
                <a href="${pageContext.request.contextPath}/"><img src="${url}/images/flower-logo.png" alt="logo img" width="100%"></a> 
              </div>
              <!-- / logo  -->
              <!-- Shipping service -->
              <div class="aa-shipping-box">
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ: 0914321426</div>
                  ...
                  <a class="aa-shipping-boxsmall">
                      <span class="aa-shipping-boxsmall-icon fas fa-shipping-fast"></span>
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Giao hàng kịp thời</div>
