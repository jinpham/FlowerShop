            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                <div class="cellphone hidden-xs">
                  <p><span class="fas fa-home"></span>Flower Shop</p>
                </div>
                <!-- start language -->
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
	                ...
	                <c:if test="${USER.name != null}">
	                 <li>
						<a href= "${pageContext.request.contextPath}/view/client/personal-page?id=${USER.id}"><strong>Hello </strong> ${USER.username }</a>
					</li>
