...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-catg-head-banner">
   <img src="${url}/images/banner.jpg" alt="banner sản phẩm">
    ...
    <div class="container">
      <div class="row">
      	<div>
      		...
      		<strong>Các bước mua hàng trên Flower Shop: </strong>
      		<p>
			...
			<p>Cách thức thực hiện cực đơn giản, dễ dàng, và nhanh chóng và có đầy đủ hướng dẫn sẽ tiết kiệm thời gian mua hàng của khách hàng.</p>
      		...
      		<p>Ngoài mua hàng thông qua website, khách hàng cũng có thể đặt hàng các sản phẩm của <strong>Flower Shop</strong> qua Hotline: 19001234</p>
