                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="email" placeholder="Email" name="transaction_email">
                              </div>                             
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" rows="1" required="required" placeholder="Địa chỉ*" name="transaction_address"></textarea>
                              </div>                             
                            </div>                            
                          </div>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="date" id = "received -date" min ="" placeholder="Ngày giao hàng*" required="required" name="transaction_received_date">
                              </div>                             
                            </div>                            
                          </div>
                           <div class="row">
                          ...
                          <div class="row" style="display: none">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                  <input type="text" placeholder="userid_session" name="transaction_usersession" value="${USER.username }"> 
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                   ...
                   <c:if test="${USER.username != null && sessionScope.order == null}">
                   <br>
...
<!--  end content-->
   <script>
		...
		document.getElementById('received -date').setAttribute("min",today);
</script>
